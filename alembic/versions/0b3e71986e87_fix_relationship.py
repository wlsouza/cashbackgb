...
def upgrade():
    ...
    op.create_index(op.f('ix_purchase_status_description'), 'purchase_status', ['description'], unique=False)
    op.create_index(op.f('ix_purchase_status_id'), 'purchase_status', ['id'], unique=False)
    ...
    sa.Column('time_created', sa.DateTime(), nullable=False),
    sa.Column('time_updated', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['status_id'], ['purchase_status.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_purchase_code'), 'purchase', ['code'], unique=False)
    op.create_index(op.f('ix_purchase_id'), 'purchase', ['id'], unique=False)
    op.create_index(op.f('ix_purchase_value'), 'purchase', ['value'], unique=True)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_purchase_status_description'), table_name='purchase_status')
